...
function(ImpactX_print_summary)
    ...
    message("    DIMS: ${ImpactX_DIMS}")
    message("    Embedded Boundary: ${ImpactX_EB}")
    message("    GPU clock timers: ${ImpactX_GPUCLOCK}")
    ...
    message("    PSATD: ${ImpactX_PSATD}")
    message("    PRECISION: ${ImpactX_PRECISION}")
    message("    OPENPMD: ${ImpactX_OPENPMD}")
    message("    QED: ${ImpactX_QED}")
    message("    QED table generation: ${ImpactX_QED_TABLE_GEN}")
