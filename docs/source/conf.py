...
latex_documents = [
    (master_doc, 'ImpactX.tex', 'ImpactX Documentation',
     'ImpactX collaboration', 'manual'),
]
...
man_pages = [
    (master_doc, 'impactx', 'ImpactX Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ImpactX', 'ImpactX Documentation',
     author, 'ImpactX', 'ImpactX is an advanced electromagnetic Particle-In-Cell code.',
     'Miscellaneous'),
]
