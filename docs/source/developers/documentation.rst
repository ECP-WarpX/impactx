...
Your Doxygen documentation is not only useful for people looking into the code, it is also part of the `ImpactX online documentation <https://impactx.readthedocs.io>`_ based on `Sphinx <http://www.sphinx-doc.org>`_!
...
.. doxygenclass:: impactx::ImpactXParticleContainer
