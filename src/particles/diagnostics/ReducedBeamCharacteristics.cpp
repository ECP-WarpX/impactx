...
namespace impactx
{
    ...
    namespace diagnostics{
        ...
        ReducedBeamCharacteristics compute_reduced_beam_characteristics(ImpactXParticleContainer const & pc) {
            ...
            ReduceOpSum,ReduceOpSum> reduce_ops;
            ...
            amrex::ReduceOps<ReduceOpSum,ReduceOpSum,ReduceOpSum,ReduceOpSum,ReduceOpSum,
                    ReduceOpSum,ReduceOpSum,ReduceOpSum,ReduceOpSum,ReduceOpSum> reduce_ops2;
            ...
            auto r2 = amrex::ParticleReduce<amrex::ReduceData<ParticleReal,ParticleReal,
                    ...
                    [=] AMREX_GPU_DEVICE(const PTDType& ptd, const int i) noexcept -> amrex::GpuTuple
                            <ParticleReal,ParticleReal,ParticleReal,ParticleReal,ParticleReal,ParticleReal,
                                    ParticleReal,ParticleReal,ParticleReal,ParticleReal>
                    {
                        const ParticleReal p_ux = ptd.m_rdata[RealSoA::ux][i];
                        const ParticleReal p_uy = ptd.m_rdata[RealSoA::uy][i];
                        const ParticleReal p_ut = ptd.m_rdata[RealSoA::pt][i];
                        ...
                        const ParticleReal p_t_ms = (p_t-t_mean)*(p_t-t_mean)*p_w;
                        ...
                        const ParticleReal p_ut_ms = (p_ut-ut_mean)*(p_ut-ut_mean)*p_w;
            ...
            ParticleReal xux    = values_per_rank_2nd.at(6) /= w_sum;
            ParticleReal yuy    = values_per_rank_2nd.at(7) /= w_sum;
            ParticleReal tut    = values_per_rank_2nd.at(8) /= w_sum;
            ParticleReal charge = values_per_rank_2nd.at(9);
            ...
            ParticleReal emittance_t = std::sqrt(t_ms*ut_ms-tut*tut);
