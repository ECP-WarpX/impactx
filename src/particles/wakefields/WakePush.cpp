...
{
    void WakePush(ImpactXParticleContainer & pc, const std::vector<double>& convoluted_wakefield, amrex::ParticleReal const slice_ds, double bin_size, double bin_min, int num_bins, int padding_factor)
    {
