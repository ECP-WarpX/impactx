...
#pragma omp parallel if (amrex::Gpu::notInLaunchRegion())
#endif
            {
                ...
                for (ParIt pti(*this, lev); pti.isValid(); ++pti) {
                    ...
                    amrex::IntVect const num_guards_rho = rho_at_level.nGrowVect();
                    ...
                    // component number in rho_at_level to deposit to
                    int const icomp = 0;
                    ...
                    ablastr::particles::deposit_charge<ImpactXParticleContainer>
                            (pti, wp, ion_lev, &rho_at_level, icomp, nc, offset, np_to_depose,
                             local_rho_fab, lev, depos_lev, charge,
                             nox, noy, noz, num_guards_rho, dx, xyzmin, rel_ref_ratio,
