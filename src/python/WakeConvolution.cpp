...
void init_wakeconvolution(py::module &m)
{
    ...
    md.def("deposit_charge", [](ImpactXParticleContainer& pc, py::array_t<amrex::Real> charge_distribution, int num_bins, amrex::Real bin_min, amrex::Real bin_size, bool is_unity_particle_weight) {
        ...
        impactx::particles::wakefields::DepositCharge1D(pc, dptr_data, num_bins, bin_min, bin_size, is_unity_particle_weight);
    ...
    md.def("derivative_charge", [](py::array_t<amrex::Real> charge_distribution, py::array_t<amrex::Real> slopes, int num_bins, amrex::Real bin_size, bool GetNumberDensity) {
        ...
        impactx::particles::wakefields::DerivativeCharge1D(charge_dist, derivatives, num_bins, bin_size, GetNumberDensity);
        ...
        int padding_factor)
    {
        ...
        return impactx::particles::wakefields::convolve_fft(beam_p, wake_f, beam_profile_size, wake_func_size, delta_t, res, padding_factor);
    }, "FFT Convolution");
}
