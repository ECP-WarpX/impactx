...
__all__ = ['MADXParser', 'RefPart', 'beam', 'elements', 'lattice', 'read_beam', 'read_lattice', 'sc', 'warnings']
class sc:
    """
    ...
    physical_constants: typing.ClassVar[dict] = {'electron-muon mass ratio': (0.00483633169, '', 1.1e-10)}
