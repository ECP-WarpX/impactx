...
import typing
__all__ = ['Alignment', 'Aperture', 'BeamMonitor', 'Buncher', 'CFbend', 'ChrAcc', 'ChrDrift', 'ChrPlasmaLens', 'ChrQuad', 'ConstF', 'DipEdge', 'Drift', 'Empty', 'ExactDrift', 'ExactSbend', 'Kicker', 'KnownElementsList', 'Multipole', 'NonlinearLens', 'PRot', 'Programmable', 'Quad', 'RFCavity', 'Sbend', 'ShortRF', 'SoftQuadrupole', 'SoftSolenoid', 'Sol', 'TaperedPL', 'Thick', 'Thin', 'ThinDipole']
class Alignment:
...
class Aperture(Thin, Alignment):
    def __init__(self, xmax: float, ymax: float, shape: str = 'rectangular', dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
        A short collimator element applying a transverse aperture boundary.
        """
    def __repr__(self) -> str:
        ...
    def push(self, pc: impactx.impactx_pybind.ImpactXParticleContainer, step: int = 0) -> None:
        """
...
class BeamMonitor(Thin):
    def __init__(self, name: str, backend: str = 'default', encoding: str = 'g') -> None:
        """
...
class Buncher(Thin, Alignment):
    def __init__(self, V: float, k: float, dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
...
class CFbend(Thick, Alignment):
    def __init__(self, ds: float, rc: float, k: float, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class ChrAcc(Thick, Alignment):
    def __init__(self, ds: float, ez: float, bz: float, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class ChrDrift(Thick, Alignment):
    def __init__(self, ds: float, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class ChrPlasmaLens(Thick, Alignment):
    def __init__(self, ds: float, k: float, unit: int = 0, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class ConstF(Thick, Alignment):
    def __init__(self, ds: float, kx: float, ky: float, kt: float, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class DipEdge(Thin, Alignment):
    def __init__(self, psi: float, rc: float, g: float, K2: float, dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
...
class ExactSbend(Thick, Alignment):
    def __init__(self, ds: float, phi: float, B: float = 0.0, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class Kicker(Thin, Alignment):
    def __init__(self, xkick: float, ykick: float, unit: str = 'dimensionless', dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
...
class KnownElementsList:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: Empty | Aperture | Buncher | CFbend | ChrAcc | ChrDrift | ChrPlasmaLens | ChrQuad | ConstF | BeamMonitor | DipEdge | Drift | ExactDrift | ExactSbend | Kicker | Multipole | NonlinearLens | Programmable | PRot | Quad | RFCavity | Sbend | ShortRF | SoftSolenoid | SoftQuadrupole | Sol | TaperedPL | ThinDipole) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: list) -> None:
        ...
    def __iter__(self) -> typing.Iterator[Empty | Aperture | Buncher | CFbend | ChrAcc | ChrDrift | ChrPlasmaLens | ChrQuad | ConstF | BeamMonitor | DipEdge | Drift | ExactDrift | ExactSbend | Kicker | Multipole | NonlinearLens | Programmable | PRot | Quad | RFCavity | Sbend | ShortRF | SoftSolenoid | SoftQuadrupole | Sol | TaperedPL | ThinDipole]:
        ...
    def __len__(self) -> int:
        """
        The length of the list.
        """
    def append(self, arg0: Empty | Aperture | Buncher | CFbend | ChrAcc | ChrDrift | ChrPlasmaLens | ChrQuad | ConstF | BeamMonitor | DipEdge | Drift | ExactDrift | ExactSbend | Kicker | Multipole | NonlinearLens | Programmable | PRot | Quad | RFCavity | Sbend | ShortRF | SoftSolenoid | SoftQuadrupole | Sol | TaperedPL | ThinDipole) -> None:
        """
...
class Multipole(Thin, Alignment):
    def __init__(self, multipole: int, K_normal: float, K_skew: float, dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
...
class NonlinearLens(Thin, Alignment):
    def __init__(self, knll: float, cnll: float, dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
...
class Programmable:
    ...
    def __repr__(self) -> str:
        ...
    @property
    def beam_particles(self) -> typing.Callable[[impactx.impactx_pybind.ImpactXParIter, impactx.impactx_pybind.RefPart], None]:
        """
        hook for beam particles (pti, RefPart)
        """
    @beam_particles.setter
    def beam_particles(self, arg1: typing.Callable[[impactx.impactx_pybind.ImpactXParIter, impactx.impactx_pybind.RefPart], None]) -> None:
        ...
    @property
    def push(self) -> typing.Callable[[impactx.impactx_pybind.ImpactXParticleContainer, int], None]:
        """
        hook for push of whole container (pc, step)
        """
    @push.setter
    def push(self, arg1: typing.Callable[[impactx.impactx_pybind.ImpactXParticleContainer, int], None]) -> None:
        ...
    @property
    def ref_particle(self) -> typing.Callable[[impactx.impactx_pybind.RefPart], None]:
        ...
        """
    @ref_particle.setter
    def ref_particle(self, arg1: typing.Callable[[impactx.impactx_pybind.RefPart], None]) -> None:
        ...
    @property
...
class Quad(Thick, Alignment):
    def __init__(self, ds: float, k: float, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
        A Quadrupole magnet.
        """
    def __repr__(self) -> str:
...
class RFCavity(Thick, Alignment):
    def __init__(self, ds: float, escale: float, freq: float, phase: float, cos_coefficients: list[float], sin_coefficients: list[float], dx: float = 0, dy: float = 0, rotation: float = 0, mapsteps: int = 1, nslice: int = 1) -> None:
        """
        An RF cavity.
        """
    def __repr__(self) -> str:
...
class Sbend(Thick, Alignment):
    def __init__(self, ds: float, rc: float, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class ShortRF(Thin, Alignment):
    def __init__(self, V: float, freq: float, phase: float = -90.0, dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
...
class SoftQuadrupole(Thick, Alignment):
    def __init__(self, ds: float, gscale: float, cos_coefficients: list[float], sin_coefficients: list[float], dx: float = 0, dy: float = 0, rotation: float = 0, mapsteps: int = 1, nslice: int = 1) -> None:
        """
...
class SoftSolenoid(Thick, Alignment):
    def __init__(self, ds: float, bscale: float, cos_coefficients: list[float], sin_coefficients: list[float], unit: float = 0, dx: float = 0, dy: float = 0, rotation: float = 0, mapsteps: int = 1, nslice: int = 1) -> None:
        """
...
class Sol(Thick, Alignment):
    def __init__(self, ds: float, ks: float, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class TaperedPL(Thin, Alignment):
    def __init__(self, k: float, taper: float, unit: int = 0, dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
...
class ThinDipole(Thin, Alignment):
    def __init__(self, theta: float, rc: float, dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
