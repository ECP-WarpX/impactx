...
__all__ = ['Alignment', 'Aperture', 'BeamMonitor', 'Buncher', 'CFbend', 'ChrAcc', 'ChrDrift', 'ChrPlasmaLens', 'ChrQuad', 'ConstF', 'DipEdge', 'Drift', 'ExactDrift', 'ExactSbend', 'Kicker', 'KnownElementsList', 'Multipole', 'None', 'NonlinearLens', 'PRot', 'Programmable', 'Quad', 'RFCavity', 'Sbend', 'ShortRF', 'SoftQuadrupole', 'SoftSolenoid', 'Sol', 'Thick', 'Thin', 'ThinDipole']
class Alignment:
...
class ChrPlasmaLens(Thick, Alignment):
    def __init__(self, ds: float, k: float, units: int = 0, dx: float = 0, dy: float = 0, rotation: float = 0, nslice: int = 1) -> None:
        """
...
class Kicker(Thin, Alignment):
    def __init__(self, xkick: float, ykick: float, units: str = 'dimensionless', dx: float = 0, dy: float = 0, rotation: float = 0) -> None:
        """
...
class KnownElementsList:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: None | Aperture | Buncher | CFbend | ChrAcc | ChrDrift | ChrPlasmaLens | ChrQuad | ConstF | BeamMonitor | DipEdge | Drift | ExactDrift | ExactSbend | Kicker | Multipole | NonlinearLens | Programmable | PRot | Quad | RFCavity | Sbend | ShortRF | SoftSolenoid | SoftQuadrupole | Sol | ThinDipole) -> None:
        ...
    @typing.overload
    ...
    def __len__(self) -> int:
        ...
        """
    def append(self, arg0: None | Aperture | Buncher | CFbend | ChrAcc | ChrDrift | ChrPlasmaLens | ChrQuad | ConstF | BeamMonitor | DipEdge | Drift | ExactDrift | ExactSbend | Kicker | Multipole | NonlinearLens | Programmable | PRot | Quad | RFCavity | Sbend | ShortRF | SoftSolenoid | SoftQuadrupole | Sol | ThinDipole) -> None:
        """
...
class SoftSolenoid(Thick, Alignment):
    def __init__(self, ds: float, bscale: float, cos_coefficients: list[float], sin_coefficients: list[float], dx: float = 0, dy: float = 0, rotation: float = 0, mapsteps: int = 1, nslice: int = 1) -> None:
        """
