...
class ImpactX:
    ...
    def __init__(self) -> None:
        ...
    def add_particles(self, bunch_charge: float, distr: distribution.None | distribution.Gaussian | distribution.Kurth4D | distribution.Kurth6D | distribution.KVdist | distribution.Thermal | distribution.Triangle | distribution.Semigaussian | distribution.Waterbag, npart: int) -> None:
        """
