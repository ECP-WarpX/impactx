...
__all__ = ['Empty', 'Gaussian', 'KVdist', 'Kurth4D', 'Kurth6D', 'Semigaussian', 'Thermal', 'Triangle', 'Waterbag']
class Empty:
    def __init__(self) -> None:
        ...
        """
class Gaussian:
    def __init__(self, lambdaX: float, lambdaY: float, lambdaT: float, lambdaPx: float, lambdaPy: float, lambdaPt: float, muxpx: float = 0.0, muypy: float = 0.0, mutpt: float = 0.0) -> None:
        """
...
class Semigaussian:
    def __init__(self, lambdaX: float, lambdaY: float, lambdaT: float, lambdaPx: float, lambdaPy: float, lambdaPt: float, muxpx: float = 0.0, muypy: float = 0.0, mutpt: float = 0.0) -> None:
        ...
        """
class Thermal:
    def __init__(self, k: float, kT: float, kT_halo: float, normalize: float, normalize_halo: float, halo: float = 0.0) -> None:
        """
