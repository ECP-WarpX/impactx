...
with open("fermi-booster-madx-3_no-sc.sxf") as f:
    text = f.read()
            ...
            if kl is None:
                ...
                for i in range(len(kl)):
                    if i == 0:
                        ...
                        mindex = i + 1
                        print(
                            f"elements.Multipole(multipole={mindex}, K_normal={kl[i]}, K_skew=0.0, rotation={tilt_deg})"
                        )
                        sim.lattice.append(
                            elements.Multipole(
                                multipole=mindex,
...
tot_energy_MeV = 1.3382720881600001e3  # reference energy
