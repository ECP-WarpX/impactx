...
C = -C1*C2*C3*C4
alphax = -(px[0]**2*(x[1]**2-x[2]**2)+px[1]**2*(x[2]**2-x[0]**2)+px[2]**2*(x[0]**2-x[1]**2))/np.sqrt(C)
betax = -2.0*(px[0]*x[0]*(x[2]**2-x[1]**2)+px[1]*x[1]*(x[0]**2-x[2]**2)+px[2]*x[2]*(x[1]**2-x[0]**2))/np.sqrt(C)
