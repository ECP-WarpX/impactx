...
assert np.allclose(
    [sigx, sigy, sigt,
     emittance_x, emittance_y, emittance_t],
    [1.595934e-03, 2.507263e-03, 9.977588e-04,
     4.490896e-06, 4.539378e-06, 0.000000e+00],
    rtol=rtol,
    atol=atol
)
...
assert np.allclose(
    [sigx, sigy, sigt,
     emittance_x, emittance_y, emittance_t],
    [1.579848e-03, 2.510900e-03, 1.208202e-02,
     4.490897e-06, 4.539378e-06, 6.384184e-16],
    rtol=rtol,
    atol=atol
)
