...
assert np.allclose(
    [sigx, sigy, sigt,
     emittance_x, emittance_y, emittance_t],
    [1.2154443728379865788e-003, 1.2154443728379865788e-003, 4.0956844276541331005317e-004,
     1.000000000e-006, 1.000000000e-006, 1.000000000e-006],
    rtol=rtol,
    atol=atol
)
...
atol = 1.0  # a big number
#rtol = num_particles**-0.5  # from random sampling of a smooth distribution
rtol = 1.0  # large tolerance without space charge included
print(f"  rtol={rtol} (ignored: atol~={atol})")
